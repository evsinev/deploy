...
back as a comment (and to Telegram), the referenced deploy [alias](./guides/writing-aliases/) is
...
<CardGrid>
  <Card title="Install & run" icon="rocket">
    Build with JDK 21 and run the [server and agents](./installation/).
  </Card>
  <Card title="Configuration" icon="setting">
    Every [environment variable](./configuration/), its default, and what it controls.
  </Card>
  <Card title="Write aliases" icon="document">
    Define deploys as [alias YAML files](./guides/writing-aliases/).
  </Card>
  <Card title="Write commands" icon="seti:shell">
    What a [command](./guides/writing-commands/) is and the bundled helper CLIs.
  </Card>
</CardGrid>
